...
(() => {
			...
			733: (e, t, r) => {
				...
				class n {
					...
					get(e) {
						...
						if (t.length > 1)
							throw new Error(
								'Expected only one property to be named "' +
									e +
									'"'
							);
					...
					mustGetByType(e, t) {
						const r = this.get(e);
						if (void 0 === r)
							throw new Error('Property "' + e + '" is missing');
						if (typeof r !== t)
							throw new Error(
								'Expected property "' +
									e +
				...
				class o {
					constructor(e) {
						(this.name = e.name),
							(this.x = e.x),
							(this.y = e.y),
							(this.properties = new n(e.properties));
					}
					get isReadable() {
					...
					for (const r of e)
						if ("objectgroup" === r.type)
							for (const e of r.objects)
								"variable" === e.type &&
									t.set(e.name, new o(e));
						else "group" === r.type && s(r.layers, t);
				}
				let a;
				async function l() {
					return (
				...
				function p(e, t, r) {
					for (const n of e)
						"group" === n.type
							? p(n.layers, t + n.name + "/", r)
							: ((n.name = t + n.name), r.set(n.name, n));
				}
				function c(e) {
					let t = 1 / 0,
						r = 1 / 0,
					...
					if ("string" == typeof i)
						throw new Error(
							"Unsupported tile layer data stored as string instead of CSV"
						);
				...
				(x.prototype.eos = function () {
							...
							null == i &&
								((i = (function (e, t) {
									...
									function b(e) {
										...
										(r = new RegExp(d(e[0]) + "\\s*")),
											(n = new RegExp("\\s*" + d(e[1]))),
											(o = new RegExp(
												"\\s*" + d("}" + e[1])
											));
									}
									b(t || V.tags);
									for (
										var E, T, k, M, P, L, B = new x(e);
										!B.eos();

									) {
										if (((E = B.pos), (k = B.scanUntil(r))))
											for (
												var G = 0, U = k.length;
												G < U;
												++G
					...
					(T.prototype.render = function (e, t, r, n) {
						var o = this.getConfigTags(n),
							i = this.parse(e, o),
							s = t instanceof E ? t : new E(t, void 0);
						return this.renderTokens(i, s, r, e, n);
					}),
					(T.prototype.renderTokens = function (e, t, r, n, o) {
						for (
							var i, s, a, l = "", p = 0, c = e.length;
							p < c;
							++p
						)
							(a = void 0),
								"#" === (s = (i = e[p])[0])
									? (a = this.renderSection(i, t, r, n, o))
									: "^" === s
									? (a = this.renderInverted(i, t, r, n, o))
									: ">" === s
									? (a = this.renderPartial(i, t, r, o))
									: "&" === s
									? (a = this.unescapedValue(i, t))
									: "name" === s
									? (a = this.escapedValue(i, t, o))
									: "text" === s && (a = this.rawValue(i)),
								void 0 !== a && (l += a);
						return l;
					}),
					(T.prototype.renderSection = function (e, t, r, n, o) {
						var i = this,
							s = "",
							a = t.lookup(e[1]);
						if (a) {
					...
					(T.prototype.renderInverted = function (e, t, r, n, o) {
						var i = t.lookup(e[1]);
						if (!i || (f(i) && 0 === i.length))
							return this.renderTokens(e[4], t, r, n, o);
					}),
					(T.prototype.indentPartial = function (e, t, r) {
						for (
							var n = t.replace(/[^ \t]/g, ""),
								o = e.split("\n"),
								i = 0;
					...
					(T.prototype.renderPartial = function (e, t, r, n) {
						if (r) {
							var o = this.getConfigTags(n),
								i = g(r) ? r(e[1]) : r[e[1]];
							if (null != i) {
								...
								0 == a &&
									l &&
									(p = this.indentPartial(i, l, s));
								var c = this.parse(p, o);
								return this.renderTokens(c, t, r, p, n);
							}
						}
					}),
					(T.prototype.unescapedValue = function (e, t) {
						var r = t.lookup(e[1]);
						if (null != r) return r;
					}),
					(T.prototype.escapedValue = function (e, t, r) {
						var n = this.getConfigEscape(r) || V.escape,
							o = t.lookup(e[1]);
						if (null != o)
							return "number" == typeof o && n === V.escape
								? String(o)
								: n(o);
					}),
					(T.prototype.rawValue = function (e) {
						return e[1];
					}),
					(T.prototype.getConfigTags = function (e) {
						return f(e)
							? e
							: e && "object" == typeof e
							? e.tags
					...
					(T.prototype.getConfigEscape = function (e) {
						return e && "object" == typeof e && !f(e)
							? e.escape
							: void 0;
					});
				var V = {
						...
						if ("string" != typeof e)
							throw new TypeError(
								'Invalid template! Template should be a "string" but "' +
									(f((o = e)) ? "array" : typeof o) +
									'" was given as the first argument for mustache#render(template, view, partials)'
							);
						var o;
						return k.render(e, t, r, n);
					}),
					(V.escape = function (e) {
				...
				class P {
					...
					onChange(e) {
						const t = [];
						for (const r of this.getUsedVariables().values())
							t.push(
								this.state.onVariableChange(r).subscribe(() => {
									const t = M.render(
										this.template,
										this.state
									);
					...
					isPureString() {
						return (
							0 === this.ast.length ||
							(1 === this.ast.length && "text" === this.ast[0][0])
						);
					}
					getUsedVariables() {
						const e = new Set();
					...
					recursiveGetUsedVariables(e, t) {
						for (const r of e) {
							const e = r[0],
								n = r[1],
								o = r[4];
							["name", "&", "#", "^"].includes(e) && t.add(n),
								void 0 !== o &&
									"string" != typeof o &&
									this.recursiveGetUsedVariables(o, t);
						}
					}
				}
				async function L() {
				...
				function B(e, t, r) {
					WA.room.setProperty(e, t, r),
						"visible" === t &&
							(r ? WA.room.showLayer(e) : WA.room.hideLayer(e));
				}
				const G =
					"https://unpkg.com/@workadventure/scripting-api-extra@1.0.5/dist";
				let U,
					j = 0,
					O = 0;
				function R(e) {
				...
				function Z(e) {
					return e
						.map((e) => U.get(e))
						.filter(
							(e) => "tilelayer" === (null == e ? void 0 : e.type)
						);
				}
				function I(e) {
					const t = u(Z(e)),
					...
					return Math.sqrt(Math.pow(j - r, 2) + Math.pow(O - n, 2));
				}
				function _(e) {
					WA.state.onVariableChange(e.name).subscribe(() => {
						WA.state[e.name]
							? (function (e) {
									const t =
											e.properties.getString("openSound"),
										r =
											e.properties.getNumber(
												"soundRadius"
											);
									let n = 1;
									if (r) {
				...
				function z(e, t, r, n) {
					...
					if (!l)
						throw new Error(
							'Missing "zone" property on doorstep layer "' +
								o +
								'"'
						);
					...
					WA.room.onEnterZone(l, () => {
						(a = !0),
							r.getBoolean("autoOpen") && c
								? (WA.state[t.name] = !0)
								: WA.state[t.name] ||
								  ((!h || c) && h) ||
								  (!r.getString("code") &&
										!r.getString("codeVariable"))
								? c && (WA.state[t.name] ? f() : g())
								: (function (e) {
										const r = u(
											Z(
												t.properties
						...
						WA.state.onVariableChange(t.name).subscribe(() => {
							a &&
								(r.getBoolean("autoClose") ||
									!0 !== WA.state[t.name] ||
									f(),
								s && !0 === WA.state[t.name] && d(),
								r.getBoolean("autoOpen") ||
									!1 !== WA.state[t.name] ||
									g());
						});
				}
				function N(e) {
					void 0 === WA.state[e.name] && (WA.state[e.name] = 0),
						WA.state.onVariableChange(e.name).subscribe(() => {
							WA.state[e.name] &&
								(function (e) {
									const t =
											e.properties.mustGetString(
												"bellSound"
											),
										r =
											e.properties.getNumber(
				...
				async function q(e) {
					...
					for (const e of t.values())
						e.properties.get("door") && _(e),
							e.properties.get("bell") && N(e);
				...
				function $(e) {
					...
					if (t) {
						...
						!(function (e, t, r, n, o, i) {
							(i && !WA.player.tags.includes(i)) ||
								(void 0 !== r &&
									WA.room.onEnterZone(t, () => {
										o || (WA.state[e] = r);
									}),
								void 0 !== n &&
									WA.room.onLeaveZone(t, () => {
										WA.state[e] = n;
									}));
						})(
							t,
						...
						q().catch((e) => console.error(e)),
							...
							(async function (e) {
								const t = (
									...
									(e) => "configuration" === e.name
								);
								if (t) {
									const r = new n(t.properties).getString(
										"tag"
									);
									(r && !WA.player.tags.includes(r)) ||
										WA.ui.registerMenuCommand(
											"Configure the room",
											() => {
												(e = null != e ? e : G),
	...
	(r.d = (e, t) => {
		...
		(() => {
			let e;
			(0, r(733).bootstrapExtra)().catch((e) => console.error(e));
			const t = new Date(),
				n = t.getHours() + ":" + t.getMinutes();
			WA.room.onEnterZone("clock", () => {
				e = WA.ui.openPopup("clockPopup", "It's " + n, []);
			}),
				WA.room.onLeaveZone("clock", function () {
